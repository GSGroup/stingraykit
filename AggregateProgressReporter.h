#ifndef STINGRAY_TOOLKIT_AGGREGATEPROGRESSREPORTER_H
#define STINGRAY_TOOLKIT_AGGREGATEPROGRESSREPORTER_H
...
namespace stingray
{
	...
	public:
		...
		{ TOOLKIT_CHECK(_actionIndex < _actionCount, IndexOutOfRangeException(_actionIndex, _actionCount)); }
