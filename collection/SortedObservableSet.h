#ifndef STINGRAY_TOOLKIT_COLLECTIONS_SORTEDOBSERVABLESET_H
#define STINGRAY_TOOLKIT_COLLECTIONS_SORTEDOBSERVABLESET_H


#include <stingray/toolkit/collection/IObservableSet.h>
#include <stingray/toolkit/collection/SortedSet.h>
