...
TEST(TimeDurationTest, ToString)
{
	...
	ASSERT_EQ(TimeDuration::Max().ToString("hh:mm:ss.llllll"), "2562047788:00:54.775807");
	...
	ASSERT_EQ(TimeDuration::FromMicroseconds(1).ToString("ll"), "00");
	ASSERT_EQ(TimeDuration::FromMicroseconds(1).ToString("lll"), "000");
	ASSERT_EQ(TimeDuration::FromMicroseconds(1).ToString("llll"), "0000");
	ASSERT_EQ(TimeDuration::FromMicroseconds(1).ToString("lllll"), "00000");
	ASSERT_EQ(TimeDuration::FromMicroseconds(1).ToString("llllll"), "000001");
	ASSERT_EQ(TimeDuration::FromMicroseconds(1).ToString("lllllll"), "000001");
	ASSERT_EQ(TimeDuration::FromMicroseconds(999999).ToString(), "00:00:00.999");
	ASSERT_EQ(TimeDuration::FromMicroseconds(999999).ToString("l"), "9");
	ASSERT_EQ(TimeDuration::FromMicroseconds(999999).ToString("ll"), "99");
	ASSERT_EQ(TimeDuration::FromMicroseconds(999999).ToString("lll"), "999");
	ASSERT_EQ(TimeDuration::FromMicroseconds(999999).ToString("llll"), "9999");
	ASSERT_EQ(TimeDuration::FromMicroseconds(999999).ToString("lllll"), "99999");
