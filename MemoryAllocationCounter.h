#ifndef __GS_DVRLIB_TOOLKIT_MEMORYALLOCATIONCOUNTER_H__
#define __GS_DVRLIB_TOOLKIT_MEMORYALLOCATIONCOUNTER_H__
...
namespace dvrlib {
	...
	public:
		...
		{
			if (event == CollectionOp::ItemAdded)
				Add(item);
			if (event == CollectionOp::ItemRemoved)
				Remove(item);
		}
