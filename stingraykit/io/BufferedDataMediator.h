...
#ifndef STINGRAYKIT_IO_BUFFEREDDATAMEDIATOR_H
#define STINGRAYKIT_IO_BUFFEREDDATAMEDIATOR_H
...
namespace stingray
{
	...
	class BufferedDataMediator : public virtual IDataMediator
	{
	private:
		ByteArray			_buffer;
		bool				_eod;
