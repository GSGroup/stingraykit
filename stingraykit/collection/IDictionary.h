...
namespace stingray
{
	...
	template < typename T >
	struct IsInheritedIReadonlyDictionary : public IsInheritedFromTemplate<T, IReadonlyDictionary>
	{ };
	...
	template < typename T >
	struct IsInheritedIDictionary : public IsInheritedFromTemplate<T, IDictionary>
	{ };
