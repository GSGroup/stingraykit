...
namespace stingray
{
	...
	template < typename T >
	struct IsInheritedIReadonlyTransactionalList : public IsInheritedFromTemplate<T, IReadonlyTransactionalList>
	{ };
	...
	template < typename T >
	struct IsInheritedITransactionalList : public IsInheritedFromTemplate<T, ITransactionalList>
	{ };
