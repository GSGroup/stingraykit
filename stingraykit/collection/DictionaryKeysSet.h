...
namespace stingray
{
	...
	template < typename DictionaryType,
			typename EnableIf<IsInheritedFromTemplate<DictionaryType, IReadonlyDictionary>::Value &&
					!IsInheritedFromTemplate<DictionaryType, IReadonlyObservableDictionary>::Value &&
					!IsInheritedFromTemplate<DictionaryType, IReadonlyTransactionalDictionary>::Value, int>::ValueT = 0 >
	...
	template < typename DictionaryType, typename EnableIf<IsInheritedFromTemplate<DictionaryType, IReadonlyObservableDictionary>::Value, int>::ValueT = 0 >
	...
	template < typename DictionaryType, typename EqualsCmp, typename EnableIf<IsInheritedFromTemplate<DictionaryType, IReadonlyTransactionalDictionary>::Value, int>::ValueT = 0 >
	...
	template < typename DictionaryType, typename EnableIf<IsInheritedFromTemplate<DictionaryType, IReadonlyTransactionalDictionary>::Value, int>::ValueT = 0 >
