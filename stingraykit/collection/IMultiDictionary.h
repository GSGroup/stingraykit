...
namespace stingray
{
	...
	template < typename T >
	struct IsInheritedIReadonlyMultiDictionary : public IsInheritedFromTemplate<T, IReadonlyMultiDictionary>
	{ };
		...
		:	public virtual IReadonlyMultiDictionary<KeyType_, ValueType_>
	{
		...
		virtual bool RemoveFirst(const KeyType& key, const optional<ValueType>& value = null) = 0;
	...
	template < typename T >
	struct IsInheritedIMultiDictionary : public IsInheritedFromTemplate<T, IMultiDictionary>
	{ };
