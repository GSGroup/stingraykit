...
namespace stingray
{
	...
	template < typename T >
	struct IsInheritedIReadonlyObservableList : public IsInheritedFromTemplate<T, IReadonlyObservableList>
	{ };
	...
	template < typename T >
	struct IsInheritedIObservableList : public IsInheritedFromTemplate<T, IObservableList>
	{ };
