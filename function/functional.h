#ifndef STINGRAY_TOOLKIT_FUNCTION_FUNCTIONAL_H
#define STINGRAY_TOOLKIT_FUNCTION_FUNCTIONAL_H
...
#define DETAIL_STINGRAY_DECLARE_NOTFUNC(ParamsCount_, ParamTypes_, ParamsDecl_, ParamsUsage_) \
			template < typename F > \
...
#define TY typename
		...
		DETAIL_STINGRAY_DECLARE_NOTFUNC(1, MK_PARAM(TY T1), MK_PARAM(P_(1)), MK_PARAM(p1));
		DETAIL_STINGRAY_DECLARE_NOTFUNC(2, MK_PARAM(TY T1, TY T2), MK_PARAM(P_(1), P_(2)), MK_PARAM(p1, p2));
		DETAIL_STINGRAY_DECLARE_NOTFUNC(3, MK_PARAM(TY T1, TY T2, TY T3), MK_PARAM(P_(1), P_(2), P_(3)), MK_PARAM(p1, p2, p3));

#undef TY
#undef P_
#undef DETAIL_STINGRAY_DECLARE_NOTFUNC
	}
